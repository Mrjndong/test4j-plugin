...
public class AnnotationUtil {
	...
	public static Method getAnnotationPropertyWithName(Class<? extends Annotation> annotation,
		...
		try {
			...
			throw new RuntimeException("Could not find annotation property named " + annotationPropertyName
	...
	public static <T> T getAnnotationPropertyValue(Method annotationProperty, Annotation annotation) {
		try {
			...
			throw new RuntimeException("Error retrieving value of property " + annotationProperty.getName()
