package org.test4j.plugin.savexp.ui;
...
import org.test4j.plugin.savexp.assistor.SaveExpHelper;
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        for (Object expression : expressions) {
            ...
            if (text != null && value != null) {
                String filename = SaveExpHelper.getJsonFile(this.javaFilePath, text);
                PluginLogger.log("begin save expression:" + filename);
                SaveExpHelper.toJSON((IJavaObject) value, filename);
            } else {
