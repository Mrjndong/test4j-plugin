package org.test4j.plugin.jspec;
...
import org.test4j.plugin.resources.prop.ClassPathPropertiesFile;

public class JSpecProp {
    private static final String                  PLUGIN_PROPERTIES          = "org/test4j/plugin/jspec/jspec.properties";
    ...
    static {
        ...
        String propertyValue = classPathPropertiesFile.getProperty("org.test4j.spec.key_words");
