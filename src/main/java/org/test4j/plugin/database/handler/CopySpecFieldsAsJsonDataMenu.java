 ...
 * @author darui.wudr
 */
public class CopySpecFieldsAsJsonDataMenu extends BaseMenuItem {

    public CopySpecFieldsAsJsonDataMenu(IViewSite viewSite) {
        super(viewSite);
    }
    ...
    protected String getMenuText() {
        return PluginMessages.DATABASE_SELECT_FIELDS_AS_JSON;
    }
