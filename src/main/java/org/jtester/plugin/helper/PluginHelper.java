...
public class PluginHelper {
	...
	public static URL iconURL(String name) {
		return JTesterActivator.getDefault().getBundle().getEntry("icons/" + name);
	}
	...
	public static String pluginBundleDirectory() {
		return JTesterActivator.getDefault().pluginBundleDirectory();
	}
	...
	public static void copyToClipBoard(String message) {
		Display display = JTesterActivator.getActiveWorkbenchShell().getDisplay();
